<x-public-layout>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div  id="invoiceForm" class="w-full mx-auto p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div id="invoiceData" class="w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <h4 class="mb-2 text-center text-3xl font-bold text-gray-900 dark:text-white">Cost Calculator</h4>
                        ...
                        <li class="pb-3 sm:pb-4">
                            <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                <div class="flex-shrink-0">
                                    <img id="logoSrc" class="w-16 h-16 rounded-full" src="{{url($user->logo)}}" alt="Logo">
                                </div>
                ...
                <form class="max-w-lg ml-auto mt-5" action="{{ route('quotations.add') }}" enctype="multipart/form-data" method="post">
                    @csrf
